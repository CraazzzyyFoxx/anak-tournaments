...
| **Discomfort** | 3+1 | `balancer/algorithm/entities.py:44-51`; `moo_core/src/context.rs:100-119`; `draft/suggestions.py:58-63`; `moo_core/src/quality_harness.rs:98-99` (bench) | Числа совпадают (0/`index*100`/1000/5000), **условия — нет**: для flex без ранга балансер даёт 5000, драфт — 0 |
