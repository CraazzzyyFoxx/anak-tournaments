...
APPROVED_DIRECT_WRITE_FILES = {
    ...
    "tournament-service/src/services/registration/teams.py",
...
PENDING_REPOSITORY_MIGRATION = {
    ...
    "tournament-service/src/rpc/pick_ban_admin.py",
    "tournament-service/src/services/admin/preview_access.py",
    "tournament-service/src/services/admin/tournament_link.py",
    "tournament-service/src/services/division_grid/import_jobs.py",
    "tournament-service/src/services/division_grid/marketplace.py",
    "tournament-service/src/services/division_grid/portable.py",
    "tournament-service/src/services/division_grid/service.py",
    "tournament-service/src/services/encounter/captain.py",
    "tournament-service/src/services/encounter/map_report.py",
    "tournament-service/src/services/encounter/pick_ban_action.py",
    "tournament-service/src/services/encounter/pick_ban_session.py",
    "tournament-service/src/services/encounter/pick_ban_undo.py",
    "tournament-service/src/services/encounter/realtime_commit.py",
    "tournament-service/src/services/encounter/report_form.py",
    "tournament-service/src/services/encounter/veto_session.py",
    "tournament-service/src/services/registration/export.py",
    "tournament-service/src/services/registration/lifecycle.py",
    "tournament-service/src/services/registration/sheet_sync.py",
    "tournament-service/src/services/scrim/service.py",
    "tournament-service/src/services/tournament/schedule.py",
}
