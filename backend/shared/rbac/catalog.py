...
PERMISSION_CATALOG: tuple[PermissionSpec, ...] = (
    ...
    *_crud("achievement"),
    ...
    # Game content (hero / gamemode / map) is global, shared by every workspace,
    # and managed by superusers only (see app-service rpc/metadata_admin.py), so
    # it has no workspace-delegable permissions here.
    *_crud("division_grid"),
