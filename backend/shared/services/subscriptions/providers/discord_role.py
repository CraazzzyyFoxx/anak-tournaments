...
re-open the fail-open question argued in ``shared.services.subscriptions.verification``.
...
from shared.services.subscriptions.discord_roles import parse_role_tiers, resolve_role_tier
