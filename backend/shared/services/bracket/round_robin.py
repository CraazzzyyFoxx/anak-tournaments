...
def generate(team_ids: list[int]) -> BracketSkeleton:
    ...
    Each team plays every other team exactly once. If the number of teams is odd,
    a BYE (None) is added and matches against BYE are skipped.

    Returns a BracketSkeleton with all pairings.
    """
    teams = list(team_ids)
