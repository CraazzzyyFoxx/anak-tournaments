...
async def _auth_user_id_for_player(session: AsyncSession, user_id: int) -> int | None:
...
async def _requirements_for_user(session: AsyncSession, auth_user_id: int) -> list[tuple[int, tuple[str, ...]]]:
