...
export default class balancerAdminService {
  ...
  static async syncTournamentSheet(tournamentId: number): Promise<AdminGoogleSheetFeedSyncResponse> {
    const response = await apiFetch("balancer",`admin/balancer/tournaments/${tournamentId}/sheet/sync`, {
      method: "POST",
      body: {},
    });
    return response.json();
  ...
  static async suggestTournamentSheetMapping(
    ...
    const response = await apiFetch("balancer",`admin/balancer/tournaments/${tournamentId}/sheet/suggest-mapping`, {
      method: "POST",
      body: data,
    });
    return response.json();
  ...
  static async previewTournamentSheetMapping(
    ...
    const response = await apiFetch("balancer",`admin/balancer/tournaments/${tournamentId}/sheet/preview`, {
      method: "POST",
      body: data,
    });
    return response.json();
  ...
  static async listApplications(
    ...
    const response = await apiFetch("balancer",`admin/balancer/tournaments/${tournamentId}/applications`, {
  ...
  static async createPlayersFromApplications(
    ...
    const response = await apiFetch("balancer",`admin/balancer/tournaments/${tournamentId}/players`, {
      method: "POST",
      body: data,
    });
    return response.json();
  ...
  static async previewPlayerImport(
    ...
    const response = await apiFetch("balancer",`admin/balancer/tournaments/${tournamentId}/players/import/preview`, {
      method: "POST",
      body: formData,
    });
    return response.json();
  ...
  static async importPlayers(
    ...
    const response = await apiFetch("balancer",`admin/balancer/tournaments/${tournamentId}/players/import`, {
      method: "POST",
      body: formData,
    });
    return response.json();
  ...
  static async exportPlayers(tournamentId: number): Promise<BalancerPlayerExportResponse> {
    const response = await apiFetch("balancer",`admin/balancer/tournaments/${tournamentId}/players/export`);
    return response.json();
  }
  ...
  static async getBalance(tournamentId: number): Promise<SavedBalance | null> {
    const response = await apiFetch("balancer",`admin/balancer/tournaments/${tournamentId}/balance`);
    return response.json();
  }
  ...
  static async exportApplicationsToUsers(tournamentId: number): Promise<ApplicationUserExportResponse> {
    const response = await apiFetch("balancer",`admin/balancer/tournaments/${tournamentId}/applications/export-users`, {
      method: "POST",
      body: {},
    });
    return response.json();
  ...
  static async importTeamsFromJson(
    ...
    const response = await apiFetch("balancer",`admin/balancer/tournaments/${tournamentId}/teams/import`, {
      method: "POST",
      body: formData,
    });
    return response.json();
  ...
  static async getRegistrationForm(tournamentId: number): Promise<AdminRegistrationForm | null> {
    const response = await apiFetch("balancer", `admin/balancer/tournaments/${tournamentId}/registration-form`);
    return response.json();
  }
  ...
  static async listRegistrations(
    ...
    const response = await apiFetch("balancer", `admin/balancer/tournaments/${tournamentId}/registrations`, {
      query: filters,
    });
    return response.json();
  }
  ...
  static async approveRegistration(registrationId: number): Promise<AdminRegistration> {
    const response = await apiFetch("balancer", `admin/balancer/registrations/${registrationId}/approve`, {
      method: "PATCH",
    });
    return response.json();
  }
  ...
  static async rejectRegistration(registrationId: number): Promise<AdminRegistration> {
    const response = await apiFetch("balancer", `admin/balancer/registrations/${registrationId}/reject`, {
      method: "PATCH",
    });
    return response.json();
  }
  ...
  static async setRegistrationExclusion(
    ...
    const response = await apiFetch("balancer", `admin/balancer/registrations/${registrationId}/exclusion`, {
      method: "PATCH",
      body: data,
    });
    return response.json();
  ...
  static async withdrawRegistration(registrationId: number): Promise<AdminRegistration> {
    const response = await apiFetch("balancer", `admin/balancer/registrations/${registrationId}/withdraw`, {
      method: "PATCH",
    });
    return response.json();
  }
  ...
  static async restoreRegistration(registrationId: number): Promise<AdminRegistration> {
    const response = await apiFetch("balancer", `admin/balancer/registrations/${registrationId}/restore`, {
      method: "PATCH",
    });
    return response.json();
  }
  ...
  static async bulkApproveRegistrations(
    ...
    const response = await apiFetch("balancer", `admin/balancer/tournaments/${tournamentId}/registrations/bulk-approve`, {
      method: "POST",
  ...
  static async setBalancerStatus(
    ...
    const response = await apiFetch("balancer", `admin/balancer/registrations/${registrationId}/balancer-status`, {
      method: "PATCH",
  ...
  static async bulkAddToBalancer(
    ...
    const response = await apiFetch("balancer", `admin/balancer/tournaments/${tournamentId}/registrations/bulk-add-to-balancer`, {
      method: "POST",
  ...
  static async checkInRegistration(
    ...
    const response = await apiFetch("balancer", `admin/balancer/registrations/${registrationId}/check-in`, {
      method: "PATCH",
  ...
  static async listStatusCatalog(workspaceId: number): Promise<BalancerCustomStatus[]> {
    const response = await apiFetch("balancer", `admin/ws/${workspaceId}/balancer-statuses/catalog`);
    return response.json();
  }
  ...
  static async createCustomStatus(
    ...
    const response = await apiFetch("balancer", `admin/ws/${workspaceId}/balancer-statuses/custom`, {
      method: "POST",
      body: data,
    });
    return response.json();
  ...
  static async updateCustomStatus(
    ...
    const response = await apiFetch("balancer", `admin/ws/${workspaceId}/balancer-statuses/custom/${statusId}`, {
      method: "PATCH",
      body: data,
    });
    return response.json();
  ...
  static async upsertBuiltinStatusOverride(
    ...
    const response = await apiFetch("balancer", `admin/ws/${workspaceId}/balancer-statuses/system/${scope}/${slug}`, {
      method: "PUT",
      body: data,
    });
    return response.json();
  ...
  static async resetBuiltinStatusOverride(
    ...
    await apiFetch("balancer", `admin/ws/${workspaceId}/balancer-statuses/system/${scope}/${slug}`, {
      method: "DELETE",
    });
  }
}
