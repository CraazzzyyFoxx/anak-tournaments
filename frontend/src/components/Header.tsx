...
const navTriggerActiveClass =
  "bg-[color:color-mix(in_srgb,var(--aqt-teal)_10%,transparent)] text-[var(--aqt-teal)] " +
  "hover:bg-[color:color-mix(in_srgb,var(--aqt-teal)_16%,transparent)] hover:text-[var(--aqt-teal)] " +
