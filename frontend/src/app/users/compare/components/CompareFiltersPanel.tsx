...
import { CompareScope } from "@/app/users/compare/types";
import { DIVISION_OPTIONS, ROLE_FILTER_OPTIONS } from "@/app/users/compare/constants";
import { parseOptionalInt, getMapIconSrc } from "@/app/users/compare/utils";
import UserSearchCombobox from "@/app/users/compare/components/UserSearchCombobox";
import SearchableImageSelect, {
  type SearchableImageOption,
} from "@/app/users/compare/components/SearchableImageSelect";
