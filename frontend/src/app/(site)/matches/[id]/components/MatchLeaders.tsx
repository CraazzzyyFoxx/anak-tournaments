...
const MatchLeaders = ({ home, away, round }: MatchLeadersProps) => {
  ...
  return (
    <div>
      <span className="aqt-mono mb-2 block text-[11px] font-bold uppercase tracking-[0.14em] text-[color:var(--aqt-fg-faint)]">
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 xl:grid-cols-6">
        {cards.map(({ name, leader }) => {
          ...
          return (
            ...
            >
              <span className="text-[11px] font-semibold uppercase tracking-[0.06em] text-[color:var(--aqt-fg-dim)]">
