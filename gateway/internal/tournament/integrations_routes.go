...
var DivisionGridRoutes = []edge.RouteSpec{
	...
	{Method: "POST", Pattern: "/api/v1/division-grids/by-workspace/{workspace_id}/marketplace/preflight", Queue: "rpc.tournament.grid_marketplace_preflight", Path: []string{"workspace_id"}, Body: true, Auth: edge.AuthRequired},
	{Method: "POST", Pattern: "/api/v1/division-grids/by-workspace/{workspace_id}/marketplace/import", Queue: "rpc.tournament.grid_marketplace_import", Path: []string{"workspace_id"}, Body: true, Auth: edge.AuthRequired, Success: 202},
	...
	{Method: "GET", Pattern: "/api/v1/division-grids/by-workspace/{workspace_id}/import-jobs/{job_id}", Queue: "rpc.tournament.grid_import_job_get", Path: []string{"workspace_id", "job_id"}, Auth: edge.AuthRequired},
	{Method: "GET", Pattern: "/api/v1/division-grids/by-workspace/{workspace_id}/import-jobs", Queue: "rpc.tournament.grid_import_jobs_list", Path: []string{"workspace_id"}, Query: []string{"active_only", "limit"}, Auth: edge.AuthRequired},
	...
	{Method: "DELETE", Pattern: "/api/v1/division-grids/library/{grid_id}", Queue: "rpc.tournament.grid_delete", IDParam: "grid_id", Query: []string{"force"}, Auth: edge.AuthRequired, Success: 204},
