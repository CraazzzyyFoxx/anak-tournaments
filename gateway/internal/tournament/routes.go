...
var PublicReadRoutes = []edge.RouteSpec{
	// tournament.py
	{Method: "GET", Pattern: "/api/v1/tournaments", Queue: "rpc.tournament.list_tournaments", AllQuery: true, Auth: edge.AuthOptional},
	...
	{Method: "GET", Pattern: "/api/v1/matches/{id}/kill-feed", Queue: "rpc.tournament.get_match_kill_feed", IDParam: "id", Query: []string{"workspace_id"}, Auth: edge.AuthOptional},
	// team.py
	{Method: "GET", Pattern: "/api/v1/teams", Queue: "rpc.tournament.list_teams", AllQuery: true, Auth: edge.AuthOptional},
	{Method: "GET", Pattern: "/api/v1/teams/{id}", Queue: "rpc.tournament.get_team", IDParam: "id", Query: []string{"entities"}, Auth: edge.AuthOptional},
}
