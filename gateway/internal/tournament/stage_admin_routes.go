...
var StageSubtreeRoutes = []edge.RouteSpec{
	...
	{Method: "GET", Pattern: "/api/v1/admin/stages/{stage_id}/bracket-preview", Queue: "rpc.tournament.stage_bracket_preview", Path: []string{"stage_id"}, Auth: edge.AuthRequired},
